...
<div id="ptsBlockMenuExl" class="ptsBlockMenu">
	...
	<div class="ptsBlockMenuEl" data-menu="fill_color">
		...
		<div class="ptsBlockMenuElRightAct">
			<div class="ptsColorpickerInputShell">
				<?php echo htmlPts::text('params[fill_color]', array(
...
<div id="ptsElMenuBtnExl" class="ptsElMenu" style="min-width: 160px;">
	<div class="ptsElMenuContent">
		<div class="ptsElMenuMainPanel">
			...
			<div class="ptsElMenuBtnDelimiter"></div>
			<div class="ptsElMenuBtn ptsColorBtn" data-sub-panel-show="color">
				<label>
					<?php _e('Color', PTS_LANG_CODE)?>
					<div class="ptsColorpickerInputShell">
						<?php echo htmlPts::text('color', array(
							'attrs' => 'class="ptsColorpickerInput"'
						));?>
					</div>
				</label>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="ptsTableSetting row col-sm-12">
								...
								<div class="ptsColorpickerInputShell">
									<?php echo htmlPts::text('badge_bg_color', array(
										'attrs' => 'class="ptsColorpickerInput"',
									));?>
								</div>
							</div>
							<div class="ptsTableSetting row col-sm-12">
								...
								<div class="ptsColorpickerInputShell">
									<?php echo htmlPts::text('badge_txt_color', array(
										'attrs' => 'class="ptsColorpickerInput"',
									));?>
								</div>
							</div>
