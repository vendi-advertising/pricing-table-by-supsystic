...
ptsBlockBase.prototype._initMenuItem_fill_color = function(newMenuItemHtml, item) {
	var self = this;
	...
	var $input = newMenuItemHtml.find('.ptsColorpickerInput'),
...
ptsBlockBase.prototype._updateFillColorFromColorpicker = function( color, ignoreAutoSave ) {
	this.setParam('fill_color', '#'+ color.toHex());
	this.setParam('fill_color_opacity', color.getAlpha());
	this._updateFillColor( ignoreAutoSave );
};
ptsBlockBase.prototype._updateFillColor = function( ignoreAutoSave ) {
	var fillColorEnb = this.getParam('fill_color_enb') == 0 ? false : true
	,	overlay = this._$.find('.ptsCoverOverlay')
...
ptsBlockBase.prototype._clickMenuItem_fill_color = function(options) {
	// Show color-picker on menu item click
	options.items.fill_color.$node.find('.ptsColorpickerInput').trigger('focus');
	return false;
};
...
ptsBlock_price_table.prototype._initCellsEdit = function( $cell ) {
	...
	$cell.each(function(){
		...
		jQuery(this).hover(function(){
			...
			jQuery(this).data('btn-shell-hide-timeout', setTimeout(function(){
...
ptsBlock_price_table.prototype._updateFillColorFromColorpicker = function( color, ignoreAutoSave ) {
...
ptsBlock_price_table.prototype._updateTextColorFromColorpicker = function( color, ignoreAutoSave ) {
	this.setParam('text_color', color.toRgbString());
	this._updateTextColor( ignoreAutoSave );
};
ptsBlock_price_table.prototype._updateTextColor = function( ignoreAutoSave ) {
	this._rebuildCss();
	/*this._$.css({
